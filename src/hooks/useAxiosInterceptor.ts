...
import { CurrentExcuteBaseURL } from "@/utils/utilts";
    ...
    async (error) => {
      ...
      try {
        ...
        if (
          ...
          setTimeout(() => {
            window.location.href = `${CurrentExcuteBaseURL}/signin`;
          }, 1000);
          return Promise.reject(error);
        }
        ...
        if (
          ...
          window.location.href = `${CurrentExcuteBaseURL}/signup/pending`;
        ...
        if (
          ...
          window.location.href = `${CurrentExcuteBaseURL}/waiting`;
